      ...
      <div className="flex gap-1.5">
        {[1, 2, 3].map((l) => (
          <div
            ...
            style={{
              background: l <= s ? barColors[s] : 'rgba(255,255,255,0.08)',
              boxShadow: l <= s ? `0 0 5px ${barColors[s]}` : 'none',
            }}
          />
        ))}
      </div>
          ...
          {success ? (
            <div className="flex flex-col items-center text-center py-6 gap-4" style={{ animation: 'badge-pop 0.5s cubic-bezier(0.34,1.56,0.64,1)' }}>
              ...
              <div>
                ...
                <p className="text-sm mt-1" style={{ color: 'rgba(148,163,184,0.5)' }}>Redirecting to login...</p>
              </div>
            </div>
          ) : (
            <>
              <form onSubmit={handleSubmit} className="auth-form space-y-4">
                ...
                <div className="field-1 space-y-1.5">
                  ...
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 pointer-events-none" style={{ color: 'rgba(148,163,184,0.35)' }} />
                    <input
              ...
              {/* Sign in link */}
              <div className="auth-footer mt-5 pt-5 text-center" style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
